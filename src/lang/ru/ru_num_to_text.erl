...
-define(RANGE_WORD, #{
    1 => {<<>>, <<>>, <<>>},
    2 => {<<"тысяча"/utf8>>, <<"тысячи"/utf8>>, <<"тысяч"/utf8>>},
    3 => {<<"миллион"/utf8>>, <<"миллиона"/utf8>>, <<"миллионов"/utf8>>},
    4 => {<<"миллиард"/utf8>>, <<"миллиарда"/utf8>>, <<"миллиардов"/utf8>>},
    5 => {<<"триллион"/utf8>>, <<"триллиона"/utf8>>, <<"триллионов"/utf8>>},
    6 => {<<"квадриллион"/utf8>>, <<"квадриллиона"/utf8>>, <<"квадриллионов"/utf8>>},
    8 => {<<"квинтиллион"/utf8>>, <<"квинтиллиона"/utf8>>, <<"квинтиллионов"/utf8>>}  
  }).
...
valid_form(Forms, Num) ->
  ...
  case Forms of
    {Result, _, _} when (LastDigit =:= 1) and (LastTwoDigits =/= 11) ->
      Result;
    {_, Result, _} 
        when 
          ((LastDigit =:= 2) or (LastDigit =:= 3) or (LastDigit =:= 4)) 
            and 
          ((LastTwoDigits > 20) or (LastTwoDigits < 10)) ->
      Result;
    {_, _, Result} ->
      Result;
    _ ->
